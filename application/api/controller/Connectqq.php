...
class Connectqq extends MobileMall
{
    ...
    public function register(){
        ...
        if (request()->isPost()){
            ...
            //获取qq账号信息
            require_once (APP_PATH.DS.'mobile'.DS.'api/qq/user/get_user_info.php');
    ...
    public function bindqq(){
        ...
        require_once (APP_PATH.DS.'mobile'.DS.'api/qq/user/get_user_info.php');
        $qquser_info = get_user_info(session('appid'), session('appkey'), session('token'), session('secret'), session('openid'));
        $edit_state     = $model_member->editMember(array('member_id'=>session('member_id')), array('member_qqopenid'=>session('openid'), 'member_qqinfo'=>serialize($qquser_info)));
        if ($edit_state){
            output_error('绑定QQ成功');
        }else {
