...
class Sellerorder extends MobileSeller
{
    ...
    public function order_list()
    {
        ...
        output_data(array('order_list' => $order_list), mobile_page($model_order->page_info));
    }
    ...
    public function order_deliver_send()
    {
        ...
        $if_allow_send = intval($order_info['lock_state']) || !in_array($order_info['order_state'], array(
                ORDER_STATE_PAY, ORDER_STATE_SEND
            ));
        if ($if_allow_send) {
            output_error('无权操作');
        }
