...
class Membervrorder extends MobileMember
{
    ...
    public function order_list()
    {
        ...
        $order_list = $model_vr_order->getOrderList($condition, $this->pagesize, '*', 'order_id desc');
        ...
        output_data(array('order_list' => $order_list), mobile_page($model_vr_order->page_info));
    }
    ...
    public function resend()
    {
        ...
        $param = array(
            ...
            'buyer_phone' => $_POST['buyer_phone'], 'goods_name' => $order_info['goods_name']
        );
