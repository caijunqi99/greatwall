...
class Sellergoods extends MobileSeller
{
    ...
    public function goods_list()
    {
        ...
        switch ($goods_type) {
            case 'lockup':
                $goods_list = $model_goods->getGoodsCommonLockUpList($condition, $fields, $this->pagesize);
                break;
            case 'offline':
                $goods_list = $model_goods->getGoodsCommonOfflineList($condition, $fields, $this->pagesize);
                break;
            default:
                $goods_list = $model_goods->getGoodsCommonOnlineList($condition, $fields, $this->pagesize);
                break;
        }
    ...
    public function goods_info()
    {
        ...
        output_data(array(
                        'goodscommon_info' => $goodscommon_info, 'sp_value' => $sp_value,
                        'attr_checked' => $attr_checked, 'spec_checked' => array_values($spec_checked),
                        'spec_json' => $spec_json, 'spec_list' => $spec_list, 'attr_list' => $attr_list
                    ));
    }
     ...
     * 商品详细信息
     */
    public function goods_image_info()
    {
        $common_id = $_POST['goods_commonid'];
        $model_goods = Model('goods');
