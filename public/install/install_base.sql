...
(12, 'flow_static_code', 'Copyright © 2013-2019 绿色长城网络开源系统 版权所有 保留一切权利', '底部版权信息'),
...
INSERT INTO `#__seo` (`seo_id`, `seo_title`, `seo_keywords`, `seo_description`, `seo_type`) VALUES (1, '{sitename} - 程序来源于绿色长城网络', 'LSMALL,PHP商城系统,LSMALL商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', '', 'index'),
(2, '{sitename} - 抢购', 'LSMALL,{sitename}', '', 'group'),
(3, '{sitename} - {name}', 'LSMALL,{name},{sitename}', 'LSMALL,{name},{sitename}', 'group_content'),
(4, '{sitename} - 品牌', 'LSMALL,{sitename}', 'LSMALL,{sitename}', 'brand'),
(5, '{sitename} - {name}', 'LSMALL,{sitename},{name}', 'LSMALL,{sitename},{name}', 'brand_list'),
(7, '{sitename} - {name}', 'LSMALL,{sitename},{name}', 'LSMALL,{sitename},{name}', 'coupon_content'),
(8, '{sitename} - 积分商城', 'LSMALL,{sitename}', 'LSMALL,{sitename}', 'point'),
(9, '{sitename} - {name}', 'LSMALL,{sitename},{key}', 'LSMALL,{sitename},{description}', 'point_content'),
(10, '{sitename} - {article_class}', 'LSMALL,{sitename}', 'LSMALL,{sitename}', 'article'),
(11, '{sitename} - {name}', 'LSMALL,{sitename},{key}', 'LSMALL,{sitename},{description}', 'article_content'),
(12, '{sitename} - {shopname}', 'LSMALL,{sitename},{key}', 'LSMALL,{sitename},{description}', 'shop'),
(13, '{name} - {sitename}', 'LSMALL,{sitename},{key}', 'LSMALL,{sitename},{description}', 'product'),
(14, '看{name}怎么淘到好的宝贝-{sitename}', 'LSMALL,{sitename},{name}', 'LSMALL,{sitename},{name}', 'sns');
